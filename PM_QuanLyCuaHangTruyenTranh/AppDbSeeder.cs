    ...
    public static class AppDbSeeder
    {
        public static void Seed()
        {
            using (var db = new AppDbContext())
            {
                ...
                var tkAdmin = new TaiKhoan { TenDangNhap = "admin", MatKhau = Helpers.PasswordHelper.HashPassword("123"), Quyen = "Admin", TrangThai = true, MaNhanVien = nv1.MaNV };
                var tkNv2 = new TaiKhoan { TenDangNhap = "nv_b", MatKhau = Helpers.PasswordHelper.HashPassword("123"), Quyen = "NhanVien", TrangThai = true, MaNhanVien = nv2.MaNV };
                var tkKh1 = new TaiKhoan { TenDangNhap = "kh_anh", MatKhau = Helpers.PasswordHelper.HashPassword("123"), Quyen = "Khach", TrangThai = true };
                var tkKh2 = new TaiKhoan { TenDangNhap = "kh_huong", MatKhau = Helpers.PasswordHelper.HashPassword("123"), Quyen = "Khach", TrangThai = true };
                var tkKh3 = new TaiKhoan { TenDangNhap = "kh_minh", MatKhau = Helpers.PasswordHelper.HashPassword("123"), Quyen = "Khach", TrangThai = true };
